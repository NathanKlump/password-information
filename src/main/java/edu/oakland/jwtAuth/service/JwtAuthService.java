...
public class JwtAuthService {
  ...
  public String getJsonBodyFromHttpServletRequest(HttpServletRequest httpServletRequest)
      throws SoffitAuthException {
    String bearerToken = getBearerToken(httpServletRequest);
    return getJsonBodyFromJWT(bearerToken);
  }

  public String getJsonBodyFromJWT(String jwtToken) throws SoffitAuthException {
    String jwtJsonString = decryptToken(jwtToken);
    DecodedJWT decoded = verifyToken(jwtJsonString);
    String jwtTokenJsonPayload = decoded.getPayload();
    String base64DecodedJsonPayload = new String(new Base64(true).decode(jwtTokenJsonPayload));
    return base64DecodedJsonPayload;
  }
